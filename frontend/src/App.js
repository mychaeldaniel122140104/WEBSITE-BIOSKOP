...
import BioskopPage from './pages/bioskop.jsx';
import HalamanBayar from './pages/HalamanBayar.jsx';
          ...
          element={
            <>
              ...
              <Routes>
                ...
                <Route path="/bioskop" element={<BioskopPage />} />
                <Route path="/menu" element={<MenuMakanan />} />
                <Route path="/bayar" element={<HalamanBayar />} />
